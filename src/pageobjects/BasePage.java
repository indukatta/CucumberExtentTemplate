...
//import Constants;
import com.factory.ExtentTestManager;
...
public class BasePage {
    ...
    public void assertEquals(Object expected, Object actual, String message){
        ...
        String logMessage = message + "- Expected value: ["+ expected.toString() + "], Actual Value: [" +
                actual.toString() + "].";
        ...
        if(expected.equals(actual)){
            ...
            //Assert.fail("Assertion Failure. Details - [" + logMessage + "]");
        }
    }

    //Assert Equals Ignore case wrapper and trim
    public void assertEqualsIgnoreCase(Object expected, Object actual, String message){

        String logMessage = message + "- Expected value: ["+ expected.toString() + "], Actual Value: [" +
                actual.toString() + "].";

        if(expected.toString().trim().equalsIgnoreCase(actual.toString().trim())){
            ExtentTestManager.getTest().log(Status.PASS,logMessage);
    ...
    //Assert notEquals wrapper
    public void assertNotEquals(Object expected, Object actual, String message){

        String logMessage = message + "- Value we are not expecting : ["+ expected.toString() + "], Actual Value: [" +
                actual.toString() + "].";
    ...
    public void assertContains(String mainString, String subString, String message){

        if(mainString.contains(subString)){
            ExtentTestManager.getTest().log(Status.PASS, message + "- Value : [" + mainString + "], does contain Value : ["+ subString + "].");
        }else{
            ExtentTestManager.getTest().log(Status.FAIL, message + "- Value : [" + mainString + "], does not contain Value : ["+ subString + "].");
            //Assert.fail("Assertion Failure. Details - [" + message + "- Value : [" + mainString + "], does not contain Value : ["+ subString + "].");
        }
    }

    //Assert not Contains wrapper
    public void assertNotContains(String mainString, String subString, String message){
        if(!mainString.contains(subString)){
            ExtentTestManager.getTest().log(Status.PASS, message + "- Value : [" + mainString + "], does not contain Value : ["+ subString + "].");
        }else{
            ExtentTestManager.getTest().log(Status.FAIL, message + "- Value : [" + mainString + "], does contain Value : ["+ subString + "].");
           // Assert.fail("Assertion Failure. Details - [" + message + "- Value : [" + mainString + "], does contain Value : ["+ subString + "].");
        }
    }

    //Assert True wrapper - use equals if the results of the check should be in the log
    public void assertIsTrue(boolean boolToCheck, String message){
        if(boolToCheck){
            ExtentTestManager.getTest().log(Status.PASS, message);
        }else{
            ExtentTestManager.getTest().log(Status.FAIL,  message);
            //Assert.fail("Assertion Failure. Details - [" + message + "]");
        }
    }

    //Assert False wrapper - use equals if the results of the check should be in the log
    public void assertIsFalse(boolean boolToCheck, String message){
        if(!boolToCheck){
            ExtentTestManager.getTest().log(Status.PASS, message);
        }else{
            ExtentTestManager.getTest().log(Status.FAIL,  message);
    ...
    //Assert not blank wrapper
    public void assertNotBlank(String actual, String message){
        if(!actual.equals("")){
            ExtentTestManager.getTest().log(Status.PASS, message + "- Actual value : ["+ actual + "].");
        }else{
            ExtentTestManager.getTest().log(Status.FAIL, message + "- Actual value : ["+ actual + "].");
            //Assert.fail("Assertion Failure. Details - [" + message + "- Actual value : [" + actual + "]");
        }
    }
}
